...
--
-- Host: 10.107.134.11    Database: dbsitetourdreams
-- ------------------------------------------------------
...
INSERT INTO `tbl_blog` VALUES (1,1,'dasdas.jpg','adasdasdaaaaaaaaa','2017-10-24 00:00:00',2),(2,1,'39d0b7b7615cdf82de3f52b70f402cfe.jpg','dfdsfsdf','2017-10-30 13:17:27',2);
...
INSERT INTO `tbl_caracteristicas_quarto_produto` VALUES (9,58),(9,40),(9,45),(10,37),(10,41),(11,41),(11,51),(11,56),(11,39),(11,55),(11,57),(11,47),(11,60);
...
INSERT INTO `tbl_fale_conosco` VALUES (16,'Carlos Morais Silva','carlos.silva2017@hotmail.com','(11) 97852-3365','Muito Bom, melhor portal de viagens do Brasil!'),(17,'','','','');
...
INSERT INTO `tbl_fotos_quartos` VALUES (9,'property1.jpg'),(9,'property4.jpg'),(9,'property3.jpg'),(10,'hotel-garda-tonellihotels.jpg'),(10,'6-pousadas-no-Nordeste-para-quem-prefere-exclusividade-900x450.jpg'),(10,'pousada-bosque-1453-03.jpg'),(11,'broom_4488.png');
...
INSERT INTO `tbl_funcionarios` VALUES (1,1,'Jose','123','joseadm@tourdreams.com','Jundiai','São Paulo','2017-10-20','blabla.jpg'),(4,1,'vgeg','ththt','ege','grgr','grgrg','2000-09-02',NULL),(5,2,'egeg','htht','rbhrb','rbrb','rbr','2000-09-08',NULL),(6,2,'Tainá','123','tainamarkenting@tourdreams.com.br','Itapevi','SP','2000-09-08',NULL);
...
INSERT INTO `tbl_nivel_usuario` VALUES (1,'Administrador'),(2,'Marketing'),(3,'Administrativo');
...
INSERT INTO `tbl_quartos` VALUES (9,70,'Muito maneiro!',200.00),(10,71,'Muito bom!',360.00),(11,70,'QUARTO LEGAL',250.00);
...
--
-- Temporary view structure for view `view_buscar_produto`
--

DROP TABLE IF EXISTS `view_buscar_produto`;
/*!50001 DROP VIEW IF EXISTS `view_buscar_produto`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_buscar_produto` AS SELECT 
 1 AS `id_produto`,
 1 AS `nome_fantasia`,
...
--
-- Final view structure for view `view_buscar_produto`
--
...
/*!50001 VIEW `view_buscar_produto` AS select `vp`.`id_produto` AS `id_produto`,`vp`.`nome_fantasia` AS `nome_fantasia`,`vp`.`descricao_produto` AS `descricao_produto`,`vp`.`preco_diaria` AS `preco_diaria`,`vp`.`foto_principal` AS `foto_principal`,`v_ava`.`media_geral` AS `media_geral` from (`view_produto` `vp` left join `view_avaliacoes` `v_ava` on((`v_ava`.`id_produto` = `vp`.`id_produto`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-11-07 16:57:30
