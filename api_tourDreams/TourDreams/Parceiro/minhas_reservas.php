<?php
	...
	if(isset($_GET['modo'])){
		$modo=$_GET['modo'];
		if ($modo=='aceitarReserva'){
			$sql="update tbl_reserva set status_reserva = 'Aprovada' where id_reserva=".$_SESSION['id_reserva'];
			echo($sql);
			mysql_query($sql);
			header("location:minhas_reservas.php?nome_empresa=".$_GET['nome_empresa']."&id_parceiro=".$_GET['id_parceiro']);
		}elseif($modo=='recusarReserva'){
				$sql="update tbl_reserva set status_reserva = 'Reprovada' where id_reserva=".$_SESSION['id_reserva'];
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														<th>Identificação Reserva</th>
														<th>Conta do Cliente</th>
														<th>Responsável do pagamento</th>
														<th>Entrada</th>
														<th>Saída</th>
														<th>Sede</th>
														<th>Quarto</th>
												...
												<?php
												$sql = "select * from view_reserva_acompanhamento where id_parceiro=".$_GET['id_parceiro'];
												$select = mysql_query($sql);
												...
												<tbody>
													<tr>
														...
														<td>
															<?php echo($rs['id_reserva']);
																$_SESSION['id_reserva'] = $rs['id_reserva'];
															?>
															
														</td>
														<td>
															<?php echo($rs['nome_cliente']);?>
														</td>
														<td>
															<?php echo($rs['nome_responsavel']);?>
														</td>
														<td>
															<?php echo($rs['dt_entrada']);?>
														</td>
														<td>
															<?php echo($rs['dt_saida']);?>
														</td>
														<td>
															<?php echo($rs['nome_empresa']);?>
														</td>
														<td>
															<?php echo($rs['id_quarto']);?>
														</td>
														<td>
															R$ <?php echo number_format($rs['valor_reserva'], 2, ',', '');?>
														</td>
														<td>
															<?php echo($rs['status_reserva']);?>
														</td>
