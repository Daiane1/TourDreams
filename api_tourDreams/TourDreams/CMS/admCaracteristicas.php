	...
	if(isset($_POST['btn_cadastro_caracteristica'])){
		...
		$id_caracteristicas = $_POST['selectCaracteristicas'];
			...
			if ($error == UPLOAD_ERR_OK) {
				...
				header("location:admCaracteristicas.php?nome_administrador=".$nome_administrador."&id_administrador=".$id_administrador."&id_nivel_usuario=".$nivel);
			}
	}
...
<html lang="pt-br">
	<head>
		...
		<meta charset="utf-8" />
		<title> TourDreams - Caracteristica</title>
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="admCaracteristicas.php?nome_administrador=<?php echo($nome_administrador);?>&id_administrador=<?php echo($id_administrador);?>&id_nivel_usuario=<?php echo($nivel);?>"  name="frmCaracteristica" method="post" enctype="multipart/form-data">
