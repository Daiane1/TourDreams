<?php
	...
	if(isset($_POST['btn_cadastro'])){
		...
		if($_POST['btn_cadastro']=='Cadastrar'){
			...
			mysql_query($sql) or die(mysql_error());
				header("location:admUser.php?nome_administrador=".$nome_administrador."&id_administrador=".$id_administrador."");
		}		
	}
	...
	if(isset($_GET['modo'])){
		...
		if ($modo=='excluir'){
			...
			mysql_query($sql);	
			header("location:admUser.php?nome_administrador=".$nome_administrador."&id_user_exluir=".$id_user_exluir."&id_administrador=".$id_administrador."");
		}elseif($modo=='editar'){
			$id_administrador=$_GET['id_administrador'];
			$nome_administrador = $_GET['nome_administrador'];
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="admUser.php?nome_administrador=<?php echo($nome_administrador);?>&id_administrador=<?php echo($id_administrador);?>" name="frmCadastro" method="post" enctype="multipart/form-data">
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="red" href="admUser.php?modo=excluir&id_user_exluir=<?php echo($rs['id_administrador']);?>&nome_administrador=<?php echo($_GET['nome_administrador']);?>&id_administrador=<?php echo($_GET['id_administrador']);?>">
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>
																<a class="green" href="admUser.php?modo=editar&id_administrador=<?php echo($rs['id_administrador']);?>&nome_administrador=<?php echo($_GET['nome_administrador']);?>">
