<?php
	...
	if(isset($_GET['modo'])){
		...
		if ($modo=='excluir'){
			...
			mysql_query($sql);
			header("location:admFale.php?nome_administrador=".$nome_administrador."&id_administrador=".$id_administrador."");
		}
	}
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="red" href="admFale.php?modo=excluir&id_fale_conosco=<?php echo($rs['id_fale_conosco']);?>&nome_administrador=<?php echo($_GET['nome_administrador']);?>&id_administrador=<?php echo($_GET['id_administrador']);?>">
