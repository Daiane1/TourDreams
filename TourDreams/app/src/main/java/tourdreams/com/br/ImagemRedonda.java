...
public class ImagemRedonda extends ImageView{

    public ImagemRedonda(Context context) {
        super(context);
    }

    public ImagemRedonda(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ImagemRedonda(Context context, AttributeSet attrs, int defStyle) {
